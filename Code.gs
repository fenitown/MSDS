...
const MASTER_SHEETS_DEF = {
  ...
  // খরচ — এজেন্সির নিজস্ব খরচের হিসাব
  "Expense": [
    "ExpenseID", "তারিখ", "বিবরণ", "পরিমাণ"
  ],
  // স্টক: পণ্য তালিকা
  "Products": [
    "ProductID", "পণ্যের নাম", "ব্র্যান্ড", "মূল্য"
  ],
  // স্টক ইন ভাউচার — এক ভাউচারে একাধিক পণ্য (ইনভয়েস নং এর মতো ভাউচার নং শেয়ার করে)
  "StockInVoucher": [
    "EntryID", "ভাউচার নং", "তারিখ", "ProductID", "পণ্যের নাম", "মূল্য", "সংখ্যা", "মোট মূল্য"
  ],
